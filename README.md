...
Instead of manually reading hundreds of reviews on e-commerce platforms, users can simply paste a product URL. The system automatically extracts the reviews, analyzes customer sentiment, and generates structured summaries and interactive insights.
...
This allows users to understand the collective customer sentiment instantly.
...
The chatbot retrieves relevant review snippets and generates answers only from actual customer reviews.

Out-of-Context Guardrails

To maintain reliability, the chatbot detects and rejects questions unrelated to the product data.
...
HUGGINGFACEHUB_API_TOKEN=hf_key #for vectorization 
